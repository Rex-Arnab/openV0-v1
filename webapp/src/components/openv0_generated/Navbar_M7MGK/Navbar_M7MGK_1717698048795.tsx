  ...
  return (
    <nav className="bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 dark:from-black dark:via-gray-900 dark:to-gray-800 px-4 py-2 shadow-md flex items-center justify-between">
      ...
      <div className="hidden md:flex space-x-4">
        <DropdownMenu>
          <DropdownMenuTrigger className="text-white hover:text-gray-200 dark:text-gray-200 dark:hover:text-gray-400">
            Home
          </DropdownMenuTrigger>
          <DropdownMenuContent>
      ...
      <Button
        variant="outline"
        className=" border-white hover:bg-white hover:text-black dark:hover:bg-gray-700">
        Login
      </Button>
    </nav>
  );
