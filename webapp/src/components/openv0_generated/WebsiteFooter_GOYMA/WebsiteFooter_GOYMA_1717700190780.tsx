  ...
  return (
    <footer className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 space-y-12">
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <a href="https://facebook.com" className="text-white hover:text-gray-700">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <a href="https://linkedin.com" className="text-white hover:text-gray-700">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <a href="https://instagram.com" className="text-white hover:text-gray-700">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <a href="https://dribbble.com" className="text-white hover:text-gray-700">
        ...
        <Separator className="my-12 border-t border-white" />

        <section className="text-center text-white">
          <p className="mb-4">
            Need help? Contact us via email <Mail className="inline h-4 w-4" className="inline h-4 w-4" />{' '}
            <a href="mailto:support@example.com" className="font-semibold hover:text-gray-900">
              support@example.com
            </a>{' '}
            or call us{' '}
            <a href="tel:+123456789" className="font-semibold hover:text-gray-900">
              +123 456 789
            </a>
          </p>
