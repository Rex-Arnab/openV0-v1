      ...
      <div className="max-w-7xl mx-auto px-4 space-y-12">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          <div className="space-y-4">
            ...
            <Card className="transform transition duration-500 hover:scale-105 bg-white text-black dark:bg-gray-800 dark:text-white">
              <CardHeader>
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <a href="https://facebook.com" className="text-white hover:text-blue-600 dark:hover:text-blue-400">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <a href="https://linkedin.com" className="text-white hover:text-blue-800 dark:hover:text-blue-600">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <a href="https://instagram.com" className="text-white hover:text-pink-500 dark:hover:text-pink-400">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <a href="https://dribbble.com" className="text-white hover:text-red-600 dark:hover:text-red-400">
