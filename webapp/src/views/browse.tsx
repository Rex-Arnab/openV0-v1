          ...
          <div
            ...
            <div>
              {generateMode === "json" ? (
                <a
                  ...
                  <div
                    className="rounded shadow dark:shadow-[#111]
				            text-center p-4
            ...
            <div className="sm:mx-4 duration-200">
              <div
                ...
                className="rounded-full shadow shadow-[#e0e0e] p-4 text-lg bg-[#ccc] hover:bg-[#111] duration-200 cursor-pointer dark:invert">
                <svg
                  height="30"
                  width="30"
                  version="1.1"
