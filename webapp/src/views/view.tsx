...
function App() {
  ...
  const [componentStream, setComponentStream] = useState<string | boolean>(
    false
  );
  ...
  return (
    <>
      <div className="min-h-screen overflow-y-auto antialiased">
        <div className={!processing ? "" : "opacity-20"}>
          <div
            ...
            <div className="sm:w-full rounded p-2 flex items-center text-xl duration-200 shadow dark:shadow-[#090909] bg-[#ddd] dark:bg-[#222] dark:text-white">
            ...
            <div className="sm:mx-4 duration-200">
              <div
                ...
                className="rounded shadow shadow-[#e0e0e] p-4 text-lg bg-[#ccc] hover:bg-[#111] duration-200 cursor-pointer dark:invert">
                <svg
                  height="30"
                  width="30"
                  version="1.1"
        ...
        <div
          ...
          <div className="mb-52 mt-2 pt-2 grid md:grid-cols-12">
            <div className="md:col-span-9 lg:col-span-10 mb-2 pb-2 sm:flex sm:items-center ">
              ...
              <div className="text-xs ml-4 flex">
                <a
                  ...
                  <img
                    className="opacity-50 hover:opacity-100 dark:invert w-6 h-6"
                ...
                <a
                  ...
                  className="cursor-pointer p-1 px-2 ml-2 bg-[#ddd] dark:bg-[#222] rounded opacity-50 hover:opacity-100 duration-200">
                  <img
                    className="opacity-50 hover:opacity-100 dark:invert w-6 h-6 p-1"
                        ...
                        <div className="break-words max-h-96 overflow-auto">
                          ...
                          {!sharedComponent ? (
                            <div className="pt-4">
                              ...
                              <br />
                              <span className="text-sm">
                                note : if you previously shared this component,
            ...
            <div className="md:col-span-3 lg:col-span-2 md:ml-2 mt-2 md:mt-0 max-h-screen overflow-auto">
              <div className="p-2 rounded bg-[#ccc] bg-opacity-10 grid grid-cols-2 md:grid-cols-1 gap-5">
                {componentStream && (
                  <a
                    href=""
                    onClick={() => {
                    ...
                    <HoverCardTrigger>
                      <a
                        ...
                        <Badge className="absolute bottom-2 right-2">
                          v{componentVersions.length - i - 1}
                        </Badge>
                        {loadedComponents &&
                          i != null &&
                          i >= 0 &&
